...
<li> 50\% of houses in Ames are smaller than 1,499.69 square feet. __[FALSE]__ </li>
...
ggplot(data = samp1, aes(x = area)) +
  geom_histogram(binwidth = 250)
```
The sample appears to mostly unimodal and is left skewed.
...
```{r sampling-dist}
sample_means50
sum(sample_means50$x_bar)/length(sample_means50$x_bar)
```
Distribution is unimodel and there are 15000 elements. The center is 1499.777.
