...
<li> __A poll conducted by WIN-Gallup International surveyed 51,917 people from 57 countries.__ </li>
...
total_count <- count(atheist_count)
atheist_count <- count(us12)
atheist_count/total_count
```
