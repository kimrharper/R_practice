...
<br>
Function for retrieving counts:
```{r}
...
ggplot()+
  ...
  geom_bar(width = 0.05)
```
<br> For 'Sex', the probability of the participant being male is slightly higher at around .52 <br>
...
<br>For 'Diabete3', the probability of the participant having diabetes is low at around .15<br>
...
For 'Diabete3', the probability of the participant not having diabetes is high at around .85<br>
