...
<li> __Range of birth weights of babies born to non-smoker mothers is greater than that of babies born to smoker mothers.__ </li>
...
```{r cutoff-mature}
#inference(y=mage, x=mature, data = nc, statistic = "mean", type = "ci",  
 #         alternative = "twosided", method = "theoretical")
...
```{r pick-your-own}
inference(y=mage, x=gender, data = nc, statistic = "mean", type = "ci",  
          alternative = "twosided", method = "theoretical")
```
